...
CC = gcc
#CC = icc
CFLAGS = -g -O3 -D _GNU_SOURCE -m64 -static
#CFLAGS = -O3 -fPIC
...
PROGS = staralign profilealign fragalign profile_two_align

OBJALIGN = mtxutl.o io.o mltaln9.o tddis.o constants.o Falign.o Galign11.o SAalignmm.o \
           defs.o fft.o fftFunctions.o Salignmm.o Kband.o

OBJSTARALIGN = $(OBJALIGN) staralign.o $(MULTIOBJ)

OBJPROFILEALIGN = $(OBJALIGN) profilealign.o $(MULTIOBJ)

OBJFRAGALIGN = $(OBJALIGN) fragalign.o $(MULTIOBJ)

OBJ2PROFILEALIGN = $(OBJALIGN) profile_two_align.o
